...
export const glyphs: Glyphs = {
	...
	meanings: {
		...
		dstringE: me([xDy], 'String Enhancement (Dyadic)', '${idx} is replaced with the corresponding item in the argumennt', { gh: 'https://github.com/abrudz/dyalog-apl-extended/tree/master#user-content-dollarsign' }),
	...
	glyphs: [
		...
		gl(';', ['semi', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
