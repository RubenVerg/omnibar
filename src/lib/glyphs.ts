...
const dy = 'dy', ex = 'ex', vi = 'vi', dz = 'dz', n2 = 'n2', a2 = 'a2', gn = 'gn', i1 = 'i1', i2 = 'i2', ax = 'ax', ng = 'ng', ka = 'ka';
...
export const glyphs: Glyphs = {
	...
	meanings: {
		...
		keyV: me([xdAy] ,'Key (Values)', 'Apply a function to unique elements of the right array and the corresponding entries in the left array', { wiki: 'https://aplwiki.com/wiki/Key' }),
		...
		keyF: me([xDy], 'Key', '???', { kap: 'https://kapdemo.dhsdevelopments.com/reference.html#_key' }),
	...
	glyphs: [
		gl('+', ['plusId', dy, ex, vi, dz, n2, a2, i1, i2, ax, ng, ka], ['conj', dy, ex, vi, n2, a2, gn, i2, ng, ka], ['add', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka]),
		gl('-', ['neg', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['sub', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['flipLetterCase', ex, dz]),
		gl('×', ['sign', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['dir', dy, ex, vi, n2, a2, gn, i2, ng, ka], ['mul', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['queryLetterCase', ex, dz], ['setLetterCase', ex]),
		gl('÷', ['rec', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['div', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['toTitleCase', ex]),
		gl('*', ['exp', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['pow', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka]),
		gl('√', ['sqrt', ex, vi, dz, n2, ka], ['root', ex, vi, dz, n2, ka]),
		gl('⍟', ['ln', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['log', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka]),
		gl('⌹', ['mInv', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng, ka], ['mDiv', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng, ka], ['qrFact', gn]),
		gl('○', ['piT', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['circ', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('!', ['fact', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['binom', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka]),
		gl('?', ['roll', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['deal', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka]),
		gl('|', ['abs', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['mag', dy, ex, vi, n2, a2, gn, i2, ng, ka], ['mod', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka], ['caseFold', ex]),
		gl('⌈', ['ceil', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['max', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['toUpper', ex, dz]),
		gl('⌊', ['floor', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['min', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['toLower', ex, dz]),
		gl('⊥', ['decode', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['decode2', ex, dz]),
		gl('⊤', ['encode', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['encode2', ex, dz], ['type', n2]),
		...
		gl('=', ['eq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['isType', ex], ['rank', vi], ['dimension', n2]),
		gl('≠', ['neq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['nubSieve', dy, vi], ['isNotType', ex], ['norm', n2]),
		gl('≤', ['leq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['isNonneg', ex], ['isInvisible', ex], ['sortAsc', vi]),
		gl('<', ['le', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['isPos', ex], ['isControl', ex], ['majorCells', vi], ['sortAsc', dz], ['condense', n2], ['promote', ka]),
		gl('>', ['ge', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['isNeg', ex], ['isVisible', ex], ['join', vi], ['sortDesc', dz], ['dilate', n2], ['demote', ka]),
		gl('≥', ['geq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['isNonpos', ex], ['isNotControl', ex], ['sortDesc', vi]),
		gl('≡', ['match', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka], ['depth', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka]),
		gl('≢', ['mismatch', dy, ex, vi, dz, n2, ax, ng, ka], ['tally', dy, ex, vi, dz, n2, ng, ka]),
		gl('∨', ['or', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['gcd', dy, ex, vi, dz, n2, gn, i2, ng], ['sortDesc', ex, ka], ['demote', vi], ['gcdM', dz]),
		gl('∧', ['and', dy, ex, vi, dz, n2, gn, i1, i2, ax, ng, ka], ['lcm', dy, ex, vi, dz, n2, gn, i2, ng], ['sortAsc', ex, ka], ['promote', vi], ['lcmM', dz]),
		gl('^', ['and', a2]),
		gl('⍱', ['nor', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['notAllEqualToType', ex], ['none', dz]),
		gl('⍲', ['nand', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['notAnyEqualToType', ex], ['notAll', dz]),
		gl('↑', ['mix', dy, ex, vi, dz, ng], ['take', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['first', n2, a2, gn, i2, ax, ka]),
		gl('↓', ['split', dy, ex, vi, dz, ng], ['drop', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['dropFirst', ka]),
		gl('⊂', ['enclose', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka], ['penclose', dy, ex, vi, dz, ng], ['partition', n2, a2, ax, ka]),
		gl('⊃', ['first', dy, ex, vi, dz, ng], ['pick', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka], ['mix', n2, a2, gn, i2, ax, ka]),
		gl('⊆', ['nest', dy, ex, vi], ['partition', dy, ex, vi], ['subset', n2], ['penclose', ka]),
		gl('⊇', ['discloseIfScalar', ex], ['from', ex, vi, dz, ka], ['last', vi], ['superset', n2]),
		gl('⌷', ['index', dy, ex, vi, dz, n2, a2, gn, ax, ng, ka], ['materialize', dy, ex, vi], ['mapKV', dz]),
		gl('⍋', ['gradeUp', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['gradeUpD', dy, ex, vi, n2, a2, gn, i2, ax, ng]),
		gl('⍒', ['gradeDown', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['gradeDownD', dy, ex, vi, n2, a2, gn, i2, ax, ng]),
		gl('⍳', ['indexGeneratorR', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['indexGeneratorI', dy, ex, vi, dz, n2, gn, i2, ng], ['indexOf', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('⍸', ['where', dy, ex, vi, dz, n2], ['intervalIndex', dy, ex, vi], ['arrayLookup', n2]),
		gl('∊', ['elementOf', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['enlist', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng]),
		gl('⍷', ['find', dy, ex, vi, dz, n2, a2, ax, ng, ka], ['type', ex, vi]),
		gl('∪', ['union', dy, ex, vi, dz, n2, ax, ng, ka], ['nub', dy, ex, vi, dz, n2, a2, ax, ng]),
		gl('∩', ['intersection', dy, ex, vi, dz, n2, ax, ng, ka], ['nubIn', ex]),
		gl('~', ['not', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['without', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka], ['m1', ex]),
		gl('§', ['symDiff', n2]),
		gl('/', ['reduce', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['wreduce', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka], ['compress', dy, ex, vi, n2, gn, i1, i2, ng], ['replicate', dy, ex, vi, n2, gn, i2, ng], ['compressO', a2, ax], ['replicateO', a2, ax]),
		gl('⌿', ['reduceF', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng, ka], ['wreduceF', dy, ex, vi, n2, a2, gn, i2, ax, ng, ka], ['compressF', dy, ex, vi, dz, n2, gn, i1, i2, ng], ['replicateF', dy, ex, vi, dz, n2, gn, i2, ng], ['compressOF', a2, ax], ['replicateOF', a2, ax]),
		gl('\\', ['scan', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['expand', dy, ex, vi, dz, n2, gn, i1, i2], ['outerProduct', ex], ['expandO', a2, ax]),
		gl('⍀', ['scanF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['expandF', dy, ex, vi, dz, n2, gn, i1, i2], ['applyRight', ex], ['expandOF', a2, ax]),
		gl(',', ['ravel', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['cat', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka]),
		gl('⍪', ['table', dy, ex, vi, dz, n2, gn, i2, ng, ka], ['catF', dy, ex, vi, dz, n2, gn, i2, ax, ng, ka], ['ravel', ax]),
		gl('⍴', ['shape', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['reshape', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('⌽', ['reverse', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['rotate', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka]),
		gl('⊖', ['reverseF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['rotateF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka]),
		gl('⍉', ['transpose', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['transposeD', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng, ka]),
		gl('¨', ['each1', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka], ['each2', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka]),
		gl('⍨', ['constant', dy, ex, vi, dz], ['commute', dy, ex, vi, dz, n2, gn, i2, ng, ka], ['duplicate', dy, ex, vi, dz, n2, gn, i2, ng, ka]),
		gl('⍣', ['repeat', dy, ex, vi, dz, n2, ng, ka], ['until', dy, ex, vi, dz, n2, ng, ka]),
		gl('⍡', ['cumulativeRepeat', dz], ['convolution', n2]),
		gl('.', ['innerProduct', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['alternant', n2]),
		gl('∙', ['innerProduct', ex], ['alternant', ex]),
		gl('∘.', ['outerProduct', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		...
		gl('⎕', ['evalInput', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['stdout', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['sys', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('⍞', ['stringInput', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['stderr', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['applyFnRef', ka]),
		...
		gl('⌺', ['stencil', dy, ex, vi]),
		gl('⌶', ['beam', dy, ex, vi]),
		gl('⍎', ['execute', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka]),
		gl('⍕', ['format', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['dformat', dy, ex, vi, n2, a2, gn, i1, i2, ax], ['formatByExample', a2, ax]),
		gl('⍬', ['zilde', dy, ex, vi, dz, n2, ax, ng]),
		gl('∞', ['inf', ex, dz, n2, ng]),
		gl('¯∞', ['ninf', ex, dz, n2, ng]),
		gl('∅', ['nan', n2]),
		gl('#', ['rootNs', dy, ex, vi]),
		...
		gl('⍵⍵⍵', ['rhyp', n2]),
		gl('χ', ['axisArg', n2, gn]),
		gl(':', ['guard', dy, ex, vi, dz, n2], ['control', dy, ex, vi, n2], ['label', dy, ex, vi, gn, i2]),
		gl('::', ['errorGuard', dy, ex, vi]),
		gl('[]', ['bindex', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['axis', dy, ex, vi, n2, a2, gn, i1, i2, ax]),
		gl(';', ['semi', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['localVar', dy, ex, vi, n2, a2, gn, i1, i2, ax], ['tuple', ka]),
		gl('←', ['assign', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['return', dz], ['sink', n2]),
		gl('⇐', ['assignFn', ka]),
		gl('→', ['branch', dy, ex, vi, n2, a2, gn, i2, ax], ['return', ka]),
		gl('∇', ['tradfn', dy, ex, vi, n2, a2, gn, i1, i2, ax], ['recfn', dy, ex, vi, dz, n2, ng], ['globalFn', ka]),
		gl('∇∇', ['recop', dy, ex, vi, n2]),
		gl('∇∇∇', ['rechyp', n2]),
		gl('¯', ['negative', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka], ['inverse', ex]),
		gl('⌂', ['dfns', ex]),
		gl('E', ['eS', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka]),
		...
		gl('ijkl', ['ijklS', n2]),
		gl('0x', ['hex', ka]),
		gl('⋄', ['sep', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng]),
		gl('⍝', ['comment', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka]),
		gl('\'', ['char', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('"', ['str', dz, gn, ka]),
		gl('λ', ['createFnRef', ka]),
		gl('«»', ['fork', ka]),
	],
