...
const dy = 'dy', ex = 'ex', vi = 'vi', dz = 'dz', n2 = 'n2';
...
export const glyphs: Glyphs = {
	...
	glyphs: [
		gl('+', ['conj', dy, ex, vi, n2], ['add', dy, ex, vi, dz, n2], ['plusId', dz]),
		gl('-', ['neg', dy, ex, vi, dz, n2], ['sub', dy, ex, vi, dz, n2], ['flipLetterCase', ex, dz]),
		gl('×', ['sign', dy, ex, vi, dz, n2], ['dir', dy, ex, vi, n2], ['mul', dy, ex, vi, dz, n2], ['queryLetterCase', ex, dz], ['setLetterCase', ex]),
		gl('÷', ['rec', dy, ex, vi, dz, n2], ['div', dy, ex, vi, dz, n2], ['toTitleCase', ex]),
		gl('*', ['exp', dy, ex, vi, dz, n2], ['pow', dy, ex, vi, dz, n2]),
		gl('√', ['sqrt', ex, vi, dz, n2], ['root', ex, vi, dz, n2]),
		gl('⍟', ['ln', dy, ex, vi, dz, n2], ['log', dy, ex, vi, dz, n2]),
		gl('⌹', ['mInv', dy, ex, vi, n2], ['mDiv', dy, ex, vi, n2]),
		gl('○', ['piT', dy, ex, vi, dz, n2], ['circ', dy, ex, vi, dz, n2]),
		gl('!', ['fact', dy, ex, vi, dz, n2], ['binom', dy, ex, vi, dz, n2]),
		gl('?', ['roll', dy, ex, vi, dz, n2], ['deal', dy, ex, vi, dz, n2]),
		gl('|', ['abs', dy, ex, vi, dz, n2], ['mag', dy, ex, vi, n2], ['mod', dy, ex, vi, dz, n2], ['caseFold', ex]),
		gl('⌈', ['ceil', dy, ex, vi, dz, n2], ['max', dy, ex, vi, dz, n2], ['toUpper', ex, dz]),
		gl('⌊', ['floor', dy, ex, vi, dz, n2], ['min', dy, ex, vi, dz, n2], ['toLower', ex, dz]),
		gl('⊥', ['decode', dy, ex, vi, dz, n2], ['decode2', ex, dz]),
		gl('⊤', ['encode', dy, ex, vi, dz, n2], ['encode2', ex, dz], ['type', n2]),
		gl('⊢', ['same', dy, ex, vi, dz, n2], ['right', dy, ex, vi, dz, n2]),
		gl('⊣', ['same', dy, ex, vi, dz, n2], ['left', dy, ex, vi, dz, n2]),
		gl('=', ['eq', dy, ex, vi, dz, n2], ['isType', ex], ['rank', vi], ['dimension', n2]),
		gl('≠', ['neq', dy, ex, vi, dz, n2], ['nubSieve', dy, vi], ['isNotType', ex], ['norm', n2]),
		gl('≤', ['leq', dy, ex, vi, dz, n2], ['isNonneg', ex], ['isInvisible', ex], ['sortAsc', vi]),
		gl('<', ['le', dy, ex, vi, dz, n2], ['isPos', ex], ['isControl', ex], ['majorCells', vi], ['sortAsc', dz], ['condense', n2]),
		gl('>', ['ge', dy, ex, vi, dz, n2], ['isNeg', ex], ['isVisible', ex], ['join', vi], ['sortDesc', dz], ['dilate', n2]),
		gl('≥', ['geq', dy, ex, vi, dz, n2], ['isNonpos', ex], ['isNotControl', ex], ['sortDesc', vi]),
		gl('≡', ['match', dy, ex, vi, dz, n2], ['depth', dy, ex, vi, dz, n2]),
		gl('≢', ['mismatch', dy, ex, vi, dz, n2], ['tally', dy, ex, vi, dz, n2]),
		gl('∨', ['or', dy, ex, vi, dz, n2], ['gcd', dy, ex, vi, dz, n2], ['sortDesc', ex], ['demote', vi], ['gcdM', dz]),
		gl('∧', ['and', dy, ex, vi, dz, n2], ['lcm', dy, ex, vi, dz, n2], ['sortAsc', ex], ['promote', vi], ['lcmM', dz]),
		gl('⍱', ['nor', dy, ex, vi, dz, n2], ['notAnyEqualToType', ex], ['notAll', dz]),
		gl('⍲', ['nand', dy, ex, vi, dz, n2], ['notAllEqualToType', ex], ['none', dz]),
		gl('↑', ['mix', dy, ex, vi, dz], ['take', dy, ex, vi, dz, n2], ['first', n2]),
		gl('↓', ['split', dy, ex, vi, dz], ['drop', dy, ex, vi, dz, n2]),
		gl('⊂', ['enclose', dy, ex, vi, dz, n2], ['penclose', dy, ex, vi, dz], ['partition', n2]),
		gl('⊃', ['first', dy, ex, vi, dz], ['pick', dy, ex, vi, dz, n2], ['mix', n2]),
		gl('⊆', ['nest', dy, ex, vi], ['partition', dy, ex, vi], ['subset', n2]),
		gl('⊇', ['discloseIfScalar', ex], ['from', ex, vi, dz], ['last', vi], ['superset', n2]),
		gl('⌷', ['index', dy, ex, vi, dz, n2], ['materialize', dy, ex, vi], ['mapKV', dz]),
		gl('⍋', ['gradeUp', dy, ex, vi, dz, n2], ['gradeUpD', dy, ex, vi, dz, n2]),
		gl('⍒', ['gradeDown', dy, ex, vi, dz, n2], ['gradeDownD', dy, ex, vi, dz, n2]),
		gl('⍳', ['indexGenerator', dy, ex, vi, dz, n2], ['indexOf', dy, ex, vi, dz, n2]),
		gl('⍸', ['where', dy, ex, vi, dz, n2], ['intervalIndex', dy, ex, vi], ['arrayLookup', n2]),
		gl('∊', ['elementOf', dy, ex, vi, dz, n2], ['enlist', dy, ex, vi, dz, n2]),
		gl('⍷', ['find', dy, ex, vi, dz, n2], ['type', ex, vi]),
		gl('∪', ['union', dy, ex, vi, dz, n2], ['nub', dy, ex, vi, dz, n2]),
		gl('∩', ['intersection', dy, ex, vi, dz, n2], ['nubIn', ex]),
		gl('~', ['not', dy, ex, vi, dz, n2], ['without', dy, ex, vi, dz, n2], ['m1', ex]),
		gl('§', ['symDiff', n2]),
		gl('/', ['reduce', dy, ex, vi, dz, n2], ['wreduce', dy, ex, vi, dz, n2], ['replicate', dy, ex, vi, n2]),
		gl('⌿', ['reduceF', dy, ex, vi, n2], ['wreduceF', dy, ex, vi, n2], ['replicateF', dy, ex, vi, dz, n2]),
		gl('\\', ['scan', dy, ex, vi, dz, n2], ['expand', dy, ex, vi, dz, n2], ['outerProduct', ex]),
		gl('⍀', ['scanF', dy, ex, vi, dz, n2], ['expandF', dy, ex, vi, dz, n2], ['applyRight', ex]),
		gl(',', ['ravel', dy, ex, vi, dz, n2], ['cat', dy, ex, vi, dz, n2]),
		gl('⍪', ['table', dy, ex, vi, dz, n2], ['catF', dy, ex, vi, dz, n2]),
		gl('⍴', ['shape', dy, ex, vi, dz, n2], ['reshape', dy, ex, vi, dz, n2]),
		gl('⌽', ['reverse', dy, ex, vi, dz, n2], ['rotate', dy, ex, vi, dz, n2]),
		gl('⊖', ['reverseF', dy, ex, vi, dz, n2], ['rotateF', dy, ex, vi, dz, n2]),
		gl('⍉', ['transpose', dy, ex, vi, dz, n2], ['transposeD', dy, ex, vi, dz, n2]),
		gl('¨', ['each1', dy, ex, vi, dz, n2], ['each2', dy, ex, vi, dz, n2]),
		...
		gl('.', ['innerProduct', dy, ex, vi, dz, n2], ['alternant', n2]),
		gl('∙', ['innerProduct', ex], ['alternant', ex]),
		gl('∘.', ['outerProduct', dy, ex, vi, dz, n2]),
		...
		gl('@', ['at', dy, ex, vi, dz]),
		gl('⍫', ['obverse', ex, vi, dz]),
		gl('⎕', ['evalInput', dy, ex, vi, dz, n2], ['stdout', dy, ex, vi, dz, n2], ['sys', dy, ex, vi, dz, n2]),
		gl('⍞', ['stringInput', dy, ex, vi, dz, n2], ['stderr', dy, ex, vi, dz, n2]),
		gl('⍠', ['variant', dy, ex, vi, n2]),
		gl('⌸', ['keyI', dy, ex, vi, dz], ['keyV', dy, ex, vi, dz], ['keyVocI', vi], ['keyVocV', vi], ['getMap', dz], ['setMap', dz]),
		gl('⍁', ['diagonals', dz]),
		gl('⌺', ['stencil', dy, ex, vi]),
		gl('⌶', ['beam', dy, ex, vi]),
		gl('⍎', ['execute', dy, ex, vi, dz, n2]),
		gl('⍕', ['format', dy, ex, vi, dz, n2], ['dformat', dy, ex, vi, n2]),
		...
		gl('[]', ['bindex', dy, ex, vi, dz, n2], ['axis', dy, ex, vi, n2]),
		gl(';', ['semi', dy, ex, vi, dz, n2]),
		gl('←', ['assign', dy, ex, vi, dz, n2], ['return', dz], ['sink', n2]),
		gl('→', ['branch', dy, ex, vi, n2]),
		gl('∇', ['tradfn', dy, ex, vi, n2], ['recfn', dy, ex, vi, dz, n2]),
		gl('∇∇', ['recop', dy, ex, vi, n2]),
		gl('∇∇∇', ['rechyp', n2]),
		gl('¯', ['negative', dy, ex, vi, dz, n2], ['inverse', ex]),
		gl('⌂', ['dfns', ex]),
		...
		gl('ijk', ['ijkS', n2]),
		gl('ijkl', ['ijklS', n2]),
		gl('⋄', ['sep', dy, ex, vi, dz, n2]),
		gl('⍝', ['comment', dy, ex, vi, dz, n2]),
		gl('\'', ['char', dy, ex, vi, dz, n2]),
		gl('"', ['str', dz]),
	],
};
