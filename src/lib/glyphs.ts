...
const dy = 'dy', ex = 'ex', vi = 'vi', dz = 'dz', n2 = 'n2', a2 = 'a2', gn = 'gn', i1 = 'i1', i2 = 'i2', ax = 'ax', ng = 'ng';
...
export const glyphs: Glyphs = {
	...
	meanings: {
		...
		demote: me([My], 'Demote', 'Combine two leading axes (like ,[⍳2])'),
	...
	glyphs: [
		...
		gl('-', ['neg', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['sub', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['flipLetterCase', ex, dz]),
		gl('×', ['sign', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['dir', dy, ex, vi, n2, a2, gn, i2, ng], ['mul', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['queryLetterCase', ex, dz], ['setLetterCase', ex]),
		gl('÷', ['rec', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['div', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['toTitleCase', ex]),
		gl('*', ['exp', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['pow', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('√', ['sqrt', ex, vi, dz, n2], ['root', ex, vi, dz, n2]),
		gl('⍟', ['ln', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['log', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('⌹', ['mInv', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng], ['mDiv', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng], ['qrFact', gn]),
		gl('○', ['piT', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['circ', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('!', ['fact', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['binom', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('?', ['roll', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['deal', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('|', ['abs', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['mag', dy, ex, vi, n2, a2, gn, i2, ng], ['mod', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng], ['caseFold', ex]),
		gl('⌈', ['ceil', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['max', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['toUpper', ex, dz]),
		gl('⌊', ['floor', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['min', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['toLower', ex, dz]),
		gl('⊥', ['decode', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['decode2', ex, dz]),
		gl('⊤', ['encode', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['encode2', ex, dz], ['type', n2]),
		gl('⊢', ['same', dy, ex, vi, dz, n2, gn, ax, ng], ['right', dy, ex, vi, dz, n2, gn, i2, ax, ng]),
		gl('⊣', ['same', dy, ex, vi, dz, n2, ng], ['left', dy, ex, vi, dz, n2, gn, i2, ax, ng], ['sink', gn], ['stop', ax]),
		gl('=', ['eq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['isType', ex], ['rank', vi], ['dimension', n2]),
		gl('≠', ['neq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['nubSieve', dy, vi], ['isNotType', ex], ['norm', n2]),
		gl('≤', ['leq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['isNonneg', ex], ['isInvisible', ex], ['sortAsc', vi]),
		gl('<', ['le', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['isPos', ex], ['isControl', ex], ['majorCells', vi], ['sortAsc', dz], ['condense', n2]),
		gl('>', ['ge', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['isNeg', ex], ['isVisible', ex], ['join', vi], ['sortDesc', dz], ['dilate', n2]),
		gl('≥', ['geq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['isNonpos', ex], ['isNotControl', ex], ['sortDesc', vi]),
		gl('≡', ['match', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng], ['depth', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng]),
		gl('≢', ['mismatch', dy, ex, vi, dz, n2, ax, ng], ['tally', dy, ex, vi, dz, n2, ng]),
		gl('∨', ['or', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['gcd', dy, ex, vi, dz, n2, gn, i2, ng], ['sortDesc', ex], ['demote', vi], ['gcdM', dz]),
		gl('∧', ['and', dy, ex, vi, dz, n2, gn, i1, i2, ax, ng], ['lcm', dy, ex, vi, dz, n2, gn, i2, ng], ['sortAsc', ex], ['promote', vi], ['lcmM', dz]),
		gl('^', ['and', a2]),
		gl('⍱', ['nor', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['notAllEqualToType', ex], ['none', dz]),
		gl('⍲', ['nand', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['notAnyEqualToType', ex], ['notAll', dz]),
		gl('↑', ['mix', dy, ex, vi, dz, ng], ['take', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['first', n2, a2, gn, i2, ax]),
		gl('↓', ['split', dy, ex, vi, dz, ng], ['drop', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('⊂', ['enclose', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng], ['penclose', dy, ex, vi, dz, ng], ['partition', n2, a2, ax]),
		gl('⊃', ['first', dy, ex, vi, dz, ng], ['pick', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng], ['mix', n2, a2, gn, i2, ax]),
		gl('⊆', ['nest', dy, ex, vi], ['partition', dy, ex, vi], ['subset', n2]),
		gl('⊇', ['discloseIfScalar', ex], ['from', ex, vi, dz], ['last', vi], ['superset', n2]),
		gl('⌷', ['index', dy, ex, vi, dz, n2, a2, gn, ax, ng], ['materialize', dy, ex, vi], ['mapKV', dz]),
		gl('⍋', ['gradeUp', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['gradeUpD', dy, ex, vi, n2, a2, gn, i2, ax, ng]),
		gl('⍒', ['gradeDown', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['gradeDownD', dy, ex, vi, n2, a2, gn, i2, ax, ng]),
		...
		gl('∊', ['elementOf', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['enlist', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng]),
		gl('⍷', ['find', dy, ex, vi, dz, n2, a2, ax, ng], ['type', ex, vi]),
		gl('∪', ['union', dy, ex, vi, dz, n2, ax, ng], ['nub', dy, ex, vi, dz, n2, a2, ax, ng]),
		gl('∩', ['intersection', dy, ex, vi, dz, n2, ax, ng], ['nubIn', ex]),
		gl('~', ['not', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['without', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng], ['m1', ex]),
		gl('§', ['symDiff', n2]),
		gl('/', ['reduce', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['wreduce', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng], ['compress', dy, ex, vi, n2, gn, i1, i2, ng], ['replicate', dy, ex, vi, n2, gn, i2, ng], ['compressO', a2, ax], ['replicateO', a2, ax]),
		gl('⌿', ['reduceF', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng], ['wreduceF', dy, ex, vi, n2, a2, gn, i2, ax, ng], ['compressF', dy, ex, vi, dz, n2, gn, i1, i2, ng], ['replicateF', dy, ex, vi, dz, n2, gn, i2, ng], ['compressOF', a2, ax], ['replicateOF', a2, ax]),
		gl('\\', ['scan', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['expand', dy, ex, vi, dz, n2, gn, i1, i2], ['outerProduct', ex], ['expandO', a2, ax]),
		gl('⍀', ['scanF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['expandF', dy, ex, vi, dz, n2, gn, i1, i2], ['applyRight', ex], ['expandOF', a2, ax]),
		gl(',', ['ravel', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['cat', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('⍪', ['table', dy, ex, vi, dz, n2, gn, i2, ng], ['catF', dy, ex, vi, dz, n2, gn, i2, ax, ng], ['ravel', ax]),
		gl('⍴', ['shape', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['reshape', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('⌽', ['reverse', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['rotate', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('⊖', ['reverseF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['rotateF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('⍉', ['transpose', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['transposeD', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng]),
		gl('¨', ['each1', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng], ['each2', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng]),
		gl('⍨', ['constant', dy, ex, vi, dz], ['commute', dy, ex, vi, dz, n2, gn, i2, ng], ['duplicate', dy, ex, vi, dz, n2, gn, i2, ng]),
		gl('⍣', ['repeat', dy, ex, vi, dz, n2, ng], ['until', dy, ex, vi, dz, n2, ng]),
		gl('⍡', ['cumulativeRepeat', dz], ['convolution', n2]),
		gl('.', ['innerProduct', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['alternant', n2]),
		gl('∙', ['innerProduct', ex], ['alternant', ex]),
		gl('∘.', ['outerProduct', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('∘', ['compose', dy, ex, vi, dz, n2, ng], ['after', dy, ex, vi, dz, n2, ng], ['bind', dy, ex, vi, dz, n2, ng], ['matrixProduct', gn]),
		gl('⍛', ['before', ex, vi, dz]),
		gl('⍤', ['compose', dy, ex, vi, dz, n2], ['atop', dy, ex, vi, dz, n2], ['atRank', dy, ex, vi, n2, gn, i2]),
		...
		gl('⍞', ['stringInput', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['stderr', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('⍠', ['variant', dy, ex, vi, n2], ['valences', ng]),
		gl('⌸', ['keyI', dy, ex, vi, dz, ng], ['keyV', dy, ex, vi, dz, ng], ['keyVocI', vi], ['keyVocV', vi], ['getMap', dz], ['setMap', dz]),
		gl('⍁', ['diagonals', dz], ['idElem', ng]),
		gl('⌺', ['stencil', dy, ex, vi]),
		gl('⌶', ['beam', dy, ex, vi]),
		gl('⍎', ['execute', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('⍕', ['format', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['dformat', dy, ex, vi, n2, a2, gn, i1, i2, ax], ['formatByExample', a2, ax]),
		...
		gl('≈', ['approxEq', ng]),
		gl('↗', ['raise', ng]),
		gl('{}', ['dfn', dy, ex, vi, dz, n2, gn, ng], ['dop', dy, ex, vi, dz, n2, gn, ng], ['dhyp', n2], ['shyRes', dy, ex, vi, n2, a2, gn], ['optLeft', dy, ex, vi]),
		gl('⍺', ['larg', dy, ex, vi, dz, n2, gn, ng], ['pictureFormat', ax]),
		gl('⍵', ['rarg', dy, ex, vi, dz, n2, gn, ng]),
		gl('⍺⍺', ['lop', dy, ex, vi, n2]),
		gl('⍶', ['lop', dz, gn, ng]),
		gl('⍵⍵', ['rop', dy, ex, vi, n2]),
		gl('⍹', ['rop', dz, gn, ng]),
		...
		gl(';', ['semi', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['localVar', dy, ex, vi, n2, a2, gn, i1, i2, ax]),
		gl('←', ['assign', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['return', dz], ['sink', n2]),
		gl('→', ['branch', dy, ex, vi, n2, a2, gn, i2, ax]),
		gl('∇', ['tradfn', dy, ex, vi, n2, a2, gn, i1, i2, ax], ['recfn', dy, ex, vi, dz, n2, ng]),
		gl('∇∇', ['recop', dy, ex, vi, n2]),
		gl('∇∇∇', ['rechyp', n2]),
		gl('¯', ['negative', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['inverse', ex]),
		gl('⌂', ['dfns', ex]),
		gl('E', ['eS', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		gl('e', ['eS', dy, ex, vi, dz, n2, ng]),
		gl('J', ['jS', dy, ex, vi, n2, a2, gn, i2, ng]),
		gl('j', ['jS', dy, ex, vi, ng]),
		gl('i', ['jS', n2]),
		gl('D', ['adS', a2]),
		gl('R', ['arS', a2]),
		...
		gl('⍝', ['comment', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
