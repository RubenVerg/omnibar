...
const dy = 'dy', ex = 'ex', vi = 'vi', dz = 'dz', n2 = 'n2', a2 = 'a2', gn = 'gn', i1 = 'i1', i2 = 'i2', ax = 'ax';
...
export const glyphs: Glyphs = {
	...
	meanings: {
		...
		pictureFormat: me([xDy], 'Picture Format', '???', { aplx: 'https://microapl.com/apl_help/ch_020_020_670.htm' }),
		...
		fileSetAllocation: me([My], 'Set File Allocation Quota', '???', { aplx: 'https://microapl.com/apl_help/ch_020_020_740.htm' }),
	...
	glyphs: [
		gl('+', ['plusId', dy, ex, vi, dz, n2, a2, i1, i2, ax], ['conj', dy, ex, vi, n2, a2, gn, i2], ['add', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('-', ['neg', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['sub', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['flipLetterCase', ex, dz]),
		gl('×', ['sign', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['dir', dy, ex, vi, n2, a2, gn, i2], ['mul', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['queryLetterCase', ex, dz], ['setLetterCase', ex]),
		gl('÷', ['rec', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['div', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['toTitleCase', ex]),
		gl('*', ['exp', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['pow', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('√', ['sqrt', ex, vi, dz, n2], ['root', ex, vi, dz, n2]),
		gl('⍟', ['ln', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['log', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('⌹', ['mInv', dy, ex, vi, n2, a2, gn, i1, i2, ax], ['mDiv', dy, ex, vi, n2, a2, gn, i1, i2, ax], ['qrFact', gn]),
		gl('○', ['piT', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['circ', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('!', ['fact', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['binom', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('?', ['roll', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['deal', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('|', ['abs', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['mag', dy, ex, vi, n2, a2, gn, i2], ['mod', dy, ex, vi, dz, n2, a2, gn, i2, ax], ['caseFold', ex]),
		gl('⌈', ['ceil', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['max', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['toUpper', ex, dz]),
		gl('⌊', ['floor', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['min', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['toLower', ex, dz]),
		gl('⊥', ['decode', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['decode2', ex, dz]),
		gl('⊤', ['encode', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['encode2', ex, dz], ['type', n2]),
		gl('⊢', ['same', dy, ex, vi, dz, n2, gn, ax], ['right', dy, ex, vi, dz, n2, gn, i2, ax]),
		gl('⊣', ['same', dy, ex, vi, dz, n2], ['left', dy, ex, vi, dz, n2, gn, i2, ax], ['sink', gn], ['stop', ax]),
		gl('=', ['eq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['isType', ex], ['rank', vi], ['dimension', n2]),
		gl('≠', ['neq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['nubSieve', dy, vi], ['isNotType', ex], ['norm', n2]),
		gl('≤', ['leq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['isNonneg', ex], ['isInvisible', ex], ['sortAsc', vi]),
		gl('<', ['le', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['isPos', ex], ['isControl', ex], ['majorCells', vi], ['sortAsc', dz], ['condense', n2]),
		gl('>', ['ge', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['isNeg', ex], ['isVisible', ex], ['join', vi], ['sortDesc', dz], ['dilate', n2]),
		gl('≥', ['geq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['isNonpos', ex], ['isNotControl', ex], ['sortDesc', vi]),
		gl('≡', ['match', dy, ex, vi, dz, n2, a2, gn, i2, ax], ['depth', dy, ex, vi, dz, n2, a2, gn, i2, ax]),
		gl('≢', ['mismatch', dy, ex, vi, dz, n2, ax], ['tally', dy, ex, vi, dz, n2]),
		gl('∨', ['or', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['gcd', dy, ex, vi, dz, n2, gn, i2], ['sortDesc', ex], ['demote', vi], ['gcdM', dz]),
		gl('∧', ['and', dy, ex, vi, dz, n2, gn, i1, i2, ax], ['lcm', dy, ex, vi, dz, n2, gn, i2], ['sortAsc', ex], ['promote', vi], ['lcmM', dz]),
		gl('^', ['and', a2]),
		gl('⍱', ['nor', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['notAllEqualToType', ex], ['none', dz]),
		gl('⍲', ['nand', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['notAnyEqualToType', ex], ['notAll', dz]),
		gl('↑', ['mix', dy, ex, vi, dz], ['take', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['first', n2, a2, gn, i2, ax]),
		gl('↓', ['split', dy, ex, vi, dz], ['drop', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('⊂', ['enclose', dy, ex, vi, dz, n2, a2, gn, i2, ax], ['penclose', dy, ex, vi, dz], ['partition', n2, a2, ax]),
		gl('⊃', ['first', dy, ex, vi, dz], ['pick', dy, ex, vi, dz, n2, a2, gn, i2, ax], ['mix', n2, a2, gn, i2, ax]),
		gl('⊆', ['nest', dy, ex, vi], ['partition', dy, ex, vi], ['subset', n2]),
		gl('⊇', ['discloseIfScalar', ex], ['from', ex, vi, dz], ['last', vi], ['superset', n2]),
		gl('⌷', ['index', dy, ex, vi, dz, n2, a2, ax], ['materialize', dy, ex, vi], ['mapKV', dz]),
		gl('⍋', ['gradeUp', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['gradeUpD', dy, ex, vi, dz, n2, a2, gn, i2, ax]),
		gl('⍒', ['gradeDown', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['gradeDownD', dy, ex, vi, dz, n2, a2, gn, i2, ax]),
		gl('⍳', ['indexGeneratorR', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['indexGeneratorI', dy, ex, vi, dz, n2, a2, gn, i2], ['indexOf', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('⍸', ['where', dy, ex, vi, dz, n2], ['intervalIndex', dy, ex, vi], ['arrayLookup', n2]),
		gl('∊', ['elementOf', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['enlist', dy, ex, vi, dz, n2, a2, gn, i2, ax]),
		gl('⍷', ['find', dy, ex, vi, dz, n2, a2, ax], ['type', ex, vi]),
		gl('∪', ['union', dy, ex, vi, dz, n2, ax], ['nub', dy, ex, vi, dz, n2, a2, ax]),
		gl('∩', ['intersection', dy, ex, vi, dz, n2, ax], ['nubIn', ex]),
		gl('~', ['not', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['without', dy, ex, vi, dz, n2, a2, gn, i2, ax], ['m1', ex]),
		gl('§', ['symDiff', n2]),
		gl('/', ['reduce', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['wreduce', dy, ex, vi, dz, n2, a2, gn, i2], ['compress', dy, ex, vi, n2, gn, i1, i2], ['replicate', dy, ex, vi, n2, gn, i2], ['compressO', a2, ax], ['replicateO', a2, ax]),
		gl('⌿', ['reduceF', dy, ex, vi, n2, a2, gn, i1, i2, ax], ['wreduceF', dy, ex, vi, n2, a2, gn, i2], ['compressF', dy, ex, vi, dz, n2, gn, i1, i2], ['replicateF', dy, ex, vi, dz, n2, gn, i2], ['compressOF', a2, ax], ['replicateOF', a2, ax]),
		gl('\\', ['scan', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['expand', dy, ex, vi, dz, n2, gn, i1, i2], ['outerProduct', ex], ['expandO', a2, ax]),
		gl('⍀', ['scanF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['expandF', dy, ex, vi, dz, n2, gn, i1, i2], ['applyRight', ex], ['expandOF', a2, ax]),
		gl(',', ['ravel', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['cat', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('⍪', ['table', dy, ex, vi, dz, n2, gn, i2], ['catF', dy, ex, vi, dz, n2, gn, i2, ax], ['ravel', ax]),
		gl('⍴', ['shape', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['reshape', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('⌽', ['reverse', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['rotate', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('⊖', ['reverseF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['rotateF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('⍉', ['transpose', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['transposeD', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('¨', ['each1', dy, ex, vi, dz, n2, a2, gn, i2, ax], ['each2', dy, ex, vi, dz, n2, a2, gn, i2, ax]),
		gl('⍨', ['constant', dy, ex, vi, dz], ['commute', dy, ex, vi, dz, n2, gn, i2], ['duplicate', dy, ex, vi, dz, n2, gn, i2]),
		gl('⍣', ['repeat', dy, ex, vi, dz, n2], ['until', dy, ex, vi, dz, n2]),
		gl('⍡', ['cumulativeRepeat', dz], ['convolution', n2]),
		gl('.', ['innerProduct', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['alternant', n2]),
		gl('∙', ['innerProduct', ex], ['alternant', ex]),
		gl('∘.', ['outerProduct', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		...
		gl('ᑈ', ['eachRight', dz]),
		gl('@', ['at', dy, ex, vi, dz]),
		gl('⍫', ['obverse', ex, vi, dz], ['lock', a2, ax]),
		gl('⎕', ['evalInput', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['stdout', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['sys', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('⍞', ['stringInput', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['stderr', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('⍠', ['variant', dy, ex, vi, n2]),
		gl('⌸', ['keyI', dy, ex, vi, dz], ['keyV', dy, ex, vi, dz], ['keyVocI', vi], ['keyVocV', vi], ['getMap', dz], ['setMap', dz]),
		gl('⍁', ['diagonals', dz]),
		gl('⌺', ['stencil', dy, ex, vi]),
		gl('⌶', ['beam', dy, ex, vi]),
		gl('⍎', ['execute', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('⍕', ['format', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['dformat', dy, ex, vi, n2, a2, gn, i1, i2, ax], ['formatByExample', a2, ax]),
		gl('⍬', ['zilde', dy, ex, vi, dz, n2, ax]),
		gl('∞', ['inf', ex, dz, n2]),
		gl('¯∞', ['ninf', ex, dz, n2]),
		gl('∅', ['nan', n2]),
		gl('#', ['rootNs', dy, ex, vi]),
		...
		gl('{}', ['dfn', dy, ex, vi, dz, n2, gn], ['dop', dy, ex, vi, dz, n2, gn], ['dhyp', n2], ['shyRes', dy, ex, vi, n2, a2, gn], ['optLeft', dy, ex, vi]),
		gl('⍺', ['larg', dy, ex, vi, dz, n2, gn], ['pictureFormat', ax]),
		...
		gl(';', ['semi', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['localVar', dy, ex, vi, n2, a2, gn, i1, i2]),
		gl('←', ['assign', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['return', dz], ['sink', n2]),
		gl('→', ['branch', dy, ex, vi, n2, a2, gn, i2]),
		gl('∇', ['tradfn', dy, ex, vi, n2, a2, gn, i1, i2, ax], ['recfn', dy, ex, vi, dz, n2]),
		gl('∇∇', ['recop', dy, ex, vi, n2]),
		gl('∇∇∇', ['rechyp', n2]),
		gl('¯', ['negative', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax], ['inverse', ex]),
		gl('⌂', ['dfns', ex]),
		...
		gl('ijk', ['ijkS', n2]),
		gl('ijkl', ['ijklS', n2]),
		gl('⋄', ['sep', dy, ex, vi, dz, n2, a2, gn, i2, ax]),
		gl('⍝', ['comment', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
