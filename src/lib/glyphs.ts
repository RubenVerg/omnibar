...
const glyphs: Glyphs = {
	...
	meanings: {
		...
		saneIndex: d('Sane Index', '???', { wiki: 'https://aplwiki.com/wiki/From' }),
		...
		intervalIndex: d('Interval Index', '???', { wiki: 'https://aplwiki.com/wiki/Interval_Index' }),
		...
		key: a('Key', 'Apply a function to unique elements of an array and their indices', { wiki: 'https://aplwiki.com/wiki/Key' }),
		...
		dformat: m('Format With Specification', '???', { wiki: 'https://aplwiki.com/wiki/Format#Dyadic_form' }),
		...
		merge: d('Merge', '???', { wiki: 'https://aplwiki.com/wiki/Case' }),
		...
		transform: h('Transform', '???', { paper: 'http://www.sudleyplace.com/APL/A%20Transform%20Hyperator%20in%20APL.pdf' }),
		...
		label: s('Label', '???', { dyalog: 'https://help.dyalog.com/18.2/Content/Language/Defined%20Functions%20and%20Operators/TradFns/Statements.htm' }),
		errorGuard: s('Error Guard', '???', { dyalog: 'https://help.dyalog.com/latest/#Language/Defined%20Functions%20and%20Operators/DynamicFunctions/Error%20Guards.htm' }),
