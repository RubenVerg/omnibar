...
export const glyphs: Glyphs = {
	...
	glyphs: [
		...
		gl('⍋', ['gradeUp', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['gradeUpD', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng]),
		gl('⍒', ['gradeDown', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['gradeDownD', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng]),
		...
		gl('\\', ['scan', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['expand', dy, ex, vi, dz, n2, gn, i1, i2, ng], ['outerProduct', ex], ['expandO', a2, ax]),
		gl('⍀', ['scanF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['expandF', dy, ex, vi, dz, n2, gn, i1, i2, ng], ['applyRight', ex], ['expandOF', a2, ax]),
		...
		gl('⍉', ['transpose', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng], ['transposeD', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng]),
		...
		gl('⌂', ['dfns', ex]),
		gl('E', ['eS', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax]),
		gl('e', ['eS', dy, ex, vi, dz, n2]),
		gl('J', ['jS', dy, ex, vi, n2, a2, gn, i2]),
		gl('j', ['jS', dy, ex, vi]),
		gl('i', ['jS', n2]),
		gl('D', ['adS', a2]),
		gl('R', ['arS', a2]),
