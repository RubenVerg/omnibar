...
const dy = 'dy', ex = 'ex', vi = 'vi', dz = 'dz', n2 = 'n2', a2 = 'a2', gn = 'gn', i1 = 'i1', i2 = 'i2';
...
export const glyphs: Glyphs = {
	...
	meanings: {
		...
		setLetterCase: me([My], 'Set Letter Case', undefined, { gh: 'https://github.com/abrudz/dyalog-apl-extended/tree/master#user-content-times' }),
	...
	glyphs: [
		gl('+', ['conj', dy, ex, vi, n2, a2, gn, i2], ['add', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['plusId', dy, ex, vi, dz, n2, a2, i1, i2]),
		gl('-', ['neg', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['sub', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['flipLetterCase', ex, dz]),
		gl('×', ['sign', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['dir', dy, ex, vi, n2, a2, gn, i2], ['mul', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['queryLetterCase', ex, dz], ['setLetterCase', ex]),
		gl('÷', ['rec', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['div', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['toTitleCase', ex]),
		gl('*', ['exp', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['pow', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('√', ['sqrt', ex, vi, dz, n2], ['root', ex, vi, dz, n2]),
		gl('⍟', ['ln', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['log', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('⌹', ['mInv', dy, ex, vi, n2, a2, gn, i1, i2], ['mDiv', dy, ex, vi, n2, a2, gn, i1, i2], ['qrFact', gn]),
		gl('○', ['piT', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['circ', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('!', ['fact', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['binom', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('?', ['roll', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['deal', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('|', ['abs', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['mag', dy, ex, vi, n2, a2, gn, i2], ['mod', dy, ex, vi, dz, n2, a2, gn, i2], ['caseFold', ex]),
		gl('⌈', ['ceil', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['max', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['toUpper', ex, dz]),
		gl('⌊', ['floor', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['min', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['toLower', ex, dz]),
		gl('⊥', ['decode', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['decode2', ex, dz]),
		gl('⊤', ['encode', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['encode2', ex, dz], ['type', n2]),
		gl('⊢', ['same', dy, ex, vi, dz, n2, gn], ['right', dy, ex, vi, dz, n2, gn, i2]),
		gl('⊣', ['same', dy, ex, vi, dz, n2], ['left', dy, ex, vi, dz, n2, gn, i2], ['sink', gn]),
		gl('=', ['eq', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['isType', ex], ['rank', vi], ['dimension', n2]),
		gl('≠', ['neq', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['nubSieve', dy, vi], ['isNotType', ex], ['norm', n2]),
		gl('≤', ['leq', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['isNonneg', ex], ['isInvisible', ex], ['sortAsc', vi]),
		gl('<', ['le', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['isPos', ex], ['isControl', ex], ['majorCells', vi], ['sortAsc', dz], ['condense', n2]),
		gl('>', ['ge', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['isNeg', ex], ['isVisible', ex], ['join', vi], ['sortDesc', dz], ['dilate', n2]),
		gl('≥', ['geq', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['isNonpos', ex], ['isNotControl', ex], ['sortDesc', vi]),
		gl('≡', ['match', dy, ex, vi, dz, n2, a2, gn, i2], ['depth', dy, ex, vi, dz, n2, a2, gn, i2]),
		gl('≢', ['mismatch', dy, ex, vi, dz, n2], ['tally', dy, ex, vi, dz, n2]),
		gl('∨', ['or', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['gcd', dy, ex, vi, dz, n2, gn, i2], ['sortDesc', ex], ['demote', vi], ['gcdM', dz]),
		gl('∧', ['and', dy, ex, vi, dz, n2, gn, i1, i2], ['lcm', dy, ex, vi, dz, n2, gn, i2], ['sortAsc', ex], ['promote', vi], ['lcmM', dz]),
		gl('^', ['and', a2]),
		gl('⍱', ['nor', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['notAllEqualToType', ex], ['none', dz]),
		gl('⍲', ['nand', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['notAnyEqualToType', ex], ['notAll', dz]),
		gl('↑', ['mix', dy, ex, vi, dz], ['take', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['first', n2, a2, gn, i2]),
		gl('↓', ['split', dy, ex, vi, dz], ['drop', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('⊂', ['enclose', dy, ex, vi, dz, n2, a2, gn, i2], ['penclose', dy, ex, vi, dz], ['partition', n2, a2]),
		gl('⊃', ['first', dy, ex, vi, dz], ['pick', dy, ex, vi, dz, n2, a2, gn, i2], ['mix', n2, a2, gn, i2]),
		...
		gl('⍋', ['gradeUp', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['gradeUpD', dy, ex, vi, dz, n2, a2, gn, i2]),
		gl('⍒', ['gradeDown', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['gradeDownD', dy, ex, vi, dz, n2, a2, gn, i2]),
		gl('⍳', ['indexGenerator', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['indexOf', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('⍸', ['where', dy, ex, vi, dz, n2], ['intervalIndex', dy, ex, vi], ['arrayLookup', n2]),
		gl('∊', ['elementOf', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['enlist', dy, ex, vi, dz, n2, a2, gn, i2]),
		gl('⍷', ['find', dy, ex, vi, dz, n2, a2], ['type', ex, vi]),
		gl('∪', ['union', dy, ex, vi, dz, n2], ['nub', dy, ex, vi, dz, n2, a2]),
		gl('∩', ['intersection', dy, ex, vi, dz, n2], ['nubIn', ex]),
		gl('~', ['not', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['without', dy, ex, vi, dz, n2, a2, gn, i2], ['m1', ex]),
		gl('§', ['symDiff', n2]),
		gl('/', ['reduce', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['wreduce', dy, ex, vi, dz, n2, a2, gn, i2], ['compress', dy, ex, vi, n2, gn, i1, i2], ['replicate', dy, ex, vi, n2, gn, i2], ['compressO', a2], ['replicateO', a2]),
		gl('⌿', ['reduceF', dy, ex, vi, n2, a2, gn, i1, i2], ['wreduceF', dy, ex, vi, n2, a2, gn, i2], ['compressF', dy, ex, vi, dz, n2, gn, i1, i2], ['replicateF', dy, ex, vi, dz, n2, gn, i2], ['compressOF', a2], ['replicateOF', a2]),
		gl('\\', ['scan', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['expand', dy, ex, vi, dz, n2, gn, i1, i2], ['outerProduct', ex], ['expandO', a2]),
		gl('⍀', ['scanF', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['expandF', dy, ex, vi, dz, n2, gn, i1, i2], ['applyRight', ex], ['expandOF', a2]),
		gl(',', ['ravel', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['cat', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('⍪', ['table', dy, ex, vi, dz, n2, gn, i2], ['catF', dy, ex, vi, dz, n2, gn, i2]),
		gl('⍴', ['shape', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['reshape', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('⌽', ['reverse', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['rotate', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('⊖', ['reverseF', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['rotateF', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('⍉', ['transpose', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['transposeD', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('¨', ['each1', dy, ex, vi, dz, n2, a2, gn, i2], ['each2', dy, ex, vi, dz, n2, a2, gn, i2]),
		...
		gl('.', ['innerProduct', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['alternant', n2]),
		gl('∙', ['innerProduct', ex], ['alternant', ex]),
		gl('∘.', ['outerProduct', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		...
		gl('@', ['at', dy, ex, vi, dz]),
		gl('⍫', ['obverse', ex, vi, dz]),
		gl('⎕', ['evalInput', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['stdout', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['sys', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('⍞', ['stringInput', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['stderr', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		...
		gl('⍕', ['format', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['dformat', dy, ex, vi, n2, a2, gn, i1, i2], ['formatByExample', a2]),
		...
		gl('[]', ['bindex', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['axis', dy, ex, vi, n2, a2, gn, i1, i2]),
		gl(';', ['semi', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['localVar', dy, ex, vi, n2, a2, gn, i1, i2]),
		gl('←', ['assign', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['return', dz], ['sink', n2]),
		gl('→', ['branch', dy, ex, vi, n2, a2, gn, i2]),
		gl('∇', ['tradfn', dy, ex, vi, n2, a2, gn, i1, i2], ['recfn', dy, ex, vi, dz, n2]),
		gl('∇∇', ['recop', dy, ex, vi, n2]),
		gl('∇∇∇', ['rechyp', n2]),
		gl('¯', ['negative', dy, ex, vi, dz, n2, a2, gn, i1, i2], ['inverse', ex]),
		gl('⌂', ['dfns', ex]),
		gl('E', ['eS', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		...
		gl('ijk', ['ijkS', n2]),
		gl('ijkl', ['ijklS', n2]),
		gl('⋄', ['sep', dy, ex, vi, dz, n2, a2, gn, i2]),
		gl('⍝', ['comment', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('\'', ['char', dy, ex, vi, dz, n2, a2, gn, i1, i2]),
		gl('"', ['str', dz, gn]),
	],
};
