...
const dy = 'dy', ex = 'ex', vi = 'vi', dz = 'dz', n2 = 'n2', a2 = 'a2', gn = 'gn', i1 = 'i1', i2 = 'i2', ax = 'ax', ng = 'ng', ka = 'ka', aw = 'aw';
...
export const glyphs: Glyphs = {
	...
	glyphs: [
		gl('+', ['plusId', dy, ex, vi, dz, n2, a2, i1, i2, ax, ng, ka, aw], ['conj', dy, ex, vi, n2, a2, gn, i2, ng, ka], ['add', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw]),
		gl('-', ['neg', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['sub', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['flipLetterCase', ex, dz]),
		gl('×', ['sign', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['dir', dy, ex, vi, n2, a2, gn, i2, ng, ka], ['mul', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['queryLetterCase', ex, dz], ['setLetterCase', ex]),
		gl('÷', ['rec', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['div', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['toTitleCase', ex]),
		gl('*', ['exp', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['pow', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw]),
		gl('√', ['sqrt', ex, vi, dz, n2, ka], ['root', ex, vi, dz, n2, ka]),
		gl('⍟', ['ln', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['log', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw]),
		gl('⌹', ['mInv', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['mDiv', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['qrFact', gn]),
		gl('○', ['piT', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, aw], ['circ', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, aw]),
		gl('!', ['fact', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['binom', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw]),
		gl('?', ['roll', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['deal', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw]),
		gl('|', ['abs', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['mag', dy, ex, vi, n2, a2, gn, i2, ng, ka], ['mod', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka, aw], ['caseFold', ex]),
		gl('⌈', ['ceil', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['max', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['toUpper', ex, dz]),
		gl('⌊', ['floor', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['min', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['toLower', ex, dz]),
		gl('⊥', ['decode', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['decode2', ex, dz]),
		gl('⊤', ['encode', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['encode2', ex, dz], ['type', n2]),
		...
		gl('=', ['eq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['isType', ex], ['rank', vi], ['dimension', n2]),
		gl('≠', ['neq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['nubSieve', dy, vi], ['isNotType', ex], ['norm', n2]),
		gl('≤', ['leq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['isNonneg', ex], ['isInvisible', ex], ['sortAsc', vi]),
		gl('<', ['le', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['isPos', ex], ['isControl', ex], ['majorCells', vi], ['sortAsc', dz], ['condense', n2], ['promote', ka]),
		gl('>', ['ge', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['isNeg', ex], ['isVisible', ex], ['join', vi], ['sortDesc', dz], ['dilate', n2], ['demote', ka]),
		gl('≥', ['geq', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['isNonpos', ex], ['isNotControl', ex], ['sortDesc', vi]),
		...
		gl('∨', ['or', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['gcd', dy, ex, vi, dz, n2, gn, i2, ng], ['sortDesc', ex, ka], ['demote', vi], ['gcdM', dz]),
		gl('∧', ['and', dy, ex, vi, dz, n2, gn, i1, i2, ax, ng, ka, aw], ['lcm', dy, ex, vi, dz, n2, gn, i2, ng], ['sortAsc', ex, ka], ['promote', vi], ['lcmM', dz]),
		gl('^', ['and', a2]),
		gl('⍱', ['nor', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['notAllEqualToType', ex], ['none', dz]),
		gl('⍲', ['nand', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['notAnyEqualToType', ex], ['notAll', dz]),
		...
		gl('⍋', ['gradeUp', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['gradeUpD', dy, ex, vi, n2, a2, gn, i2, ax, ng, aw]),
		gl('⍒', ['gradeDown', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['gradeDownD', dy, ex, vi, n2, a2, gn, i2, ax, ng, aw]),
		gl('⍳', ['indexGeneratorR', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, aw], ['indexGeneratorI', dy, ex, vi, dz, n2, gn, i2, ng], ['indexOf', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, aw]),
		gl('⍸', ['where', dy, ex, vi, dz, n2], ['intervalIndex', dy, ex, vi], ['arrayLookup', n2]),
		gl('∊', ['elementOf', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['enlist', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, aw]),
		...
		gl('~', ['not', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['without', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka], ['m1', ex]),
		gl('§', ['symDiff', n2]),
		gl('/', ['reduce', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['wreduce', dy, ex, vi, dz, n2, a2, gn, i2, ax, ng, ka], ['compress', dy, ex, vi, n2, gn, i1, i2, ng], ['replicate', dy, ex, vi, n2, gn, i2, ng], ['compressO', a2, ax, aw], ['replicateO', a2, ax, aw]),
		gl('⌿', ['reduceF', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['wreduceF', dy, ex, vi, n2, a2, gn, i2, ax, ng, ka], ['compressF', dy, ex, vi, dz, n2, gn, i1, i2, ng], ['replicateF', dy, ex, vi, dz, n2, gn, i2, ng], ['compressOF', a2, ax, aw], ['replicateOF', a2, ax, aw]),
		gl('\\', ['scan', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['expand', dy, ex, vi, dz, n2, gn, i1, i2], ['outerProduct', ex], ['expandO', a2, ax, aw]),
		gl('⍀', ['scanF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['expandF', dy, ex, vi, dz, n2, gn, i1, i2], ['applyRight', ex], ['expandOF', a2, ax, aw]),
		gl(',', ['ravel', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['cat', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw]),
		gl('⍪', ['table', dy, ex, vi, dz, n2, gn, i2, ng, ka], ['catF', dy, ex, vi, dz, n2, gn, i2, ax, ng, ka, aw], ['ravel', ax]),
		gl('⍴', ['shape', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, aw], ['reshape', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, aw]),
		gl('⌽', ['reverse', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['rotate', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw]),
		gl('⊖', ['reverseF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['rotateF', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw]),
		gl('⍉', ['transpose', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['transposeD', dy, ex, vi, n2, a2, gn, i1, i2, ax, ng, ka, aw]),
		...
		gl('[]', ['bindex', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, aw], ['axis', dy, ex, vi, n2, a2, gn, i1, i2, ax, aw]),
		gl(';', ['semi', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, aw], ['localVar', dy, ex, vi, n2, a2, gn, i1, i2, ax, aw], ['tuple', ka]),
		gl('←', ['assign', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, ng, ka, aw], ['return', dz], ['sink', n2, aw]),
		gl('⇐', ['assignFn', ka]),
		gl('→', ['branch', dy, ex, vi, n2, a2, gn, i2, ax, aw], ['return', ka]),
		gl('∇', ['tradfn', dy, ex, vi, n2, a2, gn, i1, i2, ax, aw], ['recfn', dy, ex, vi, dz, n2, ng], ['globalFn', ka]),
		...
		gl('\'', ['char', dy, ex, vi, dz, n2, a2, gn, i1, i2, ax, aw]),
