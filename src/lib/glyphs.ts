...
export const glyphs: Glyphs = {
	...
	meanings: {
		...
		alternant: me([dCey], 'Alternant', 'Generalized discriminant', { wiki: 'https://aplwiki.com/wiki/Determinant', nars2000: 'https://wiki.nars2000.org/index.php?title=Determinant_Operator' }),
